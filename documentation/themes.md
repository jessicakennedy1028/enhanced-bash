...
I thought I would try out making a theme section since each person has different ideas, tastes, and concepts on how 
they want their console and GUI desktop wallpaper to look.

Located in the /themes folder, you will find at least my theme, located there. To change the theme, open the /bin/bash.conf
file and look for. As for the Wallpaper, I am still manually changing it in the GUI Background configuration. Maybe I will
make something different someday.
...
The name of the theme will be the name after the thm_ in the themes folder. An example theme:
...
if [ "${TERM}" != "xterm-256color" ]; then
    ...
    # Define the colors for GCC
    export GCC_COLORS='error=01;31:warning=01;35:note=01;36:caret=01;32:locus=01:quote=01'

    # Define the colors for directories and different file types
    ...
    # Define colors for LESS (or whatever you want to define)
    ...
    # WG_USER_MARKER
    # Depending on if I was root or a user it would change the colors of the prompt.
    if [ ${UID} -eq 0 ]; then
        USER_BG="8;5;130m"
        USER_FG="7m"
    else
    ...
    # I wanted to have a different colored prompt if I was on a SSH connection or LOCAL. Since I have a shared home folder over NFS, when
    # I log into each server it pulls this theme's configuration.
